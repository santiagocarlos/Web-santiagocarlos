...
<head>
  ...
  <title>Categorías - Carlos Santiago</title>
  ...
  <link href="{{ asset('assets-for-demo/vertical-nav.css') }}" rel="stylesheet" />
...
<body class="index-page">
  <nav class="navbar navbar-default navbar-transparent navbar-fixed-top navbar-color-on-scroll" color-on-scroll=" " id="sectionsNav">
      <div class="container">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="presentation.html">Carlos Santiago</a>
          </div>
  ...
  <div class="page-header" data-parallax="true" style="background-image: url('{{ asset('img/bg9.jpg') }}');">
    <div class="container">
      <div class="row">
                              ...
                              <li class="dropdown">
                                  <a href="#pablo" class="profile-photo dropdown-toggle" data-toggle="dropdown">
                                      <div class="profile-photo-small">
                                          <img src="{{ asset('img/faces/avatar.jpg') }}" alt="Circle Image" class="img-circle img-responsive">
                                      </div>
                                  </a>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="gallery-feed">
                      <img src="{{ asset('img/faces/card-profile6-square.jpg') }}" class="img img-raised img-rounded" alt="" />
                      <img src="{{ asset('img/faces/christian.jpg') }}" class="img img-raised img-rounded" alt="" />
                      <img src="{{ asset('img/faces/card-profile4-square.jpg') }}" class="img img-raised img-rounded" alt="" />
                      <img src="{{ asset('img/faces/card-profile1-square.jpg') }}" class="img img-raised img-rounded" alt="" />

                      <img src="{{ asset('img/faces/marc.jpg') }}" class="img img-raised img-rounded" alt="" />
                      <img src="{{ asset('img/faces/kendall.jpg') }}" class="img img-raised img-rounded" alt="" />
                      <img src="{{ asset('img/faces/card-profile5-square.jpg') }}" class="img img-raised img-rounded" alt="" />
                      <img src="{{ asset('img/faces/card-profile2-square.jpg') }}" class="img img-raised img-rounded" alt="" />
                    </div>
  ...
  <!--                 images -->
            ...
            <div class="col-sm-2">
                          <h4>Rounded Image</h4>
                          <img src="{{ asset('img/faces/avatar.jpg') }}" alt="Rounded Image" class="img-rounded img-responsive">
                      </div>
            ...
            <div class="col-sm-2 col-sm-offset-1">
                          ...
                          <img src="{{ asset('img/faces/avatar.jpg') }}" alt="Raised Image" class="img-rounded img-responsive img-raised">
                      </div>

                      <div class="col-sm-2 col-sm-offset-1">
                          <h4>Circle Raised</h4>
                          <img src="{{ asset('img/faces/avatar.jpg') }}" alt="Thumbnail Image" class="img-circle img-raised img-responsive">
                      </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="media-area">
                      ...
                      <div class="media">
                        <a class="pull-left" href="#pablo">
                          <div class="avatar">
                            <img class="media-object" src="{{ asset('img/faces/avatar.jpg') }}" alt="..."/>
                          </div>
                        </a>
                        <div class="media-body">
                          ...
                          <div class="media media-post">
                            <a class="pull-left author" href="#pablo">
                              <div class="avatar">
                                <img class="media-object" alt="64x64" src="{{ asset('img/faces/kendall.jpg') }}">
                              </div>
                            </a>
                            <div class="media-body">
                      ...
                      <div class="media">
                        <a class="pull-left" href="#pablo">
                          <div class="avatar">
                           <img class="media-object" alt="Tim Picture" src="{{ asset('img/faces/marc.jpg') }}">
                          </div>
                        </a>
                        <div class="media-body">
                        ...
                        <div class="media-footer">
                         ...
                         <div class="media">
                            <a class="pull-left" href="#pablo">
                              <div class="avatar">
                                <img class="media-object" alt="64x64" src="{{ asset('img/faces/avatar.jpg') }}">
                              </div>
                            </a>
                            <div class="media-body">
                        ...
                        <ul class="pagination">
                          ...
                          <li><a href="#pablo">&raquo;</a></li>
                              ...
                              <div class="media media-post">
                                    <a class="pull-left author" href="#pablo">
                                        <div class="avatar">
                                              <img class="media-object" alt="64x64" src="{{ asset('img/placeholder.jpg') }}"/>
                                        </div>
                                    </a>
                                    <div class="media-body">
                            <form class="form">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="card card-blog">
                    <div class="card-image">
                      <a href="#pablo">
                        <img class="img" src="{{ asset('img/examples/card-blog1.jpg') }}" />
                ...
                <div class="card">
                    <div class="card-content content-info">
                      ...
                      <div class="footer">
                                        <div class="author">
                                            <a href="#pablo">
                                               <img src="{{ asset('img/faces/avatar.jpg') }}" alt="..." class="avatar img-raised">
                ...
                <div class="col-md-4">
                  <div class="card">
                    <div class="card-content">
                      ...
                      <div class="footer">
                                        <div class="author">
                                            <a href="#pablo">
                                               <img src="{{ asset('img/faces/christian.jpg') }}" alt="..." class="avatar img-raised">
                                               <span>Lord Alex</span>
                                            </a>
                                        </div>
                                       <div class="stats">
                  ...
                  <div class="card card-blog">
                    <div class="card-image">
                      <a href="#pablo">
                        <img class="img" src="{{ asset('img/examples/card-blog2.jpg') }}" />
                      </a>
                    </div>
                    ...
                    <div class="card-content">
                      ...
                      <div class="footer">
                                        <div class="author">
                                            <a href="#pablo">
                                               <img src="{{ asset('img/faces/marc.jpg') }}" alt="..." class="avatar img-raised">
                                               <span>Mike John</span>
                                            </a>
                                        </div>
                                       <div class="stats">
                ...
                <div class="col-md-4">
                  <div class="card card-blog">
                    <div class="card-image">
                      <a href="#pablo">
                        <img class="img" src="{{ asset('img/examples/blog8.jpg') }}" />
                      </a>
                    </div>
                    <div class="card-content">
                      <h6 class="category text-danger">
              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <div class="card card-profile">
                    <div class="card-image">
                      <a href="#pablo">
                        <img class="img" src="{{ asset('img/examples/card-profile4.jpg') }}" />
                ...
                <div class="col-md-4">
                  <div class="card card-profile">
                    <div class="card-image">
                      <a href="#pablo">
                        <img class="img" src="{{ asset('img/examples/card-profile1.jpg') }}" />
                      </a>
                    </div>
            ...
            <div class="container">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="card card-background" style="background-image: url('{{ asset('img/examples/office1.jpg') }}')">
                ...
                <div class="col-md-6">
                  <div class="card card-background" style="background-image: url('{{ asset('img/examples/card-blog3.jpg') }}')">
                    <div class="card-content">
          ...
          <div class="cards">
            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="card card-pricing card-background" style="background-image: url('{{ asset('img/examples/card-blog3.jpg') }}')">
                    <div class="card-content">
          ...
          <div class="cards" id="morphing">
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-lg-4">
                ...
                <div class="rotating-card-container manual-flip">
                  <div class="card card-rotate">
                    <div class="front front-background" style="background-image: url('{{ asset('img/examples/card-blog6.jpg') }}');">
                      <div class="card-content">
                        <h6 class="category text-info">Full Background Card</h6>
                        <a href="#pablo">
                    ...
                    <div class="back back-background" style="background-image: url('{{ asset('img/examples/card-blog6.jpg') }}');">
                      <div class="card-content">
                        <h5 class="card-title">
                          Manage Post
                        </h5>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card card-blog">
                <div class="card-image">
                  <a href="#pablo">
                    <img src="{{ asset('img/examples/color1.jpg') }}" alt="" />
                  </a>
                </div>
                <div class="card-content">
            ...
            <div class="col-md-4">
              ...
              <div class="card card-blog">
                <div class="card-image">
                  <a href="#pablo">
                    <img src="{{ asset('img/examples/color2.jpg') }}" alt="" />
                  </a>
                </div>
                <div class="card-content">
            ...
            <div class="col-md-4">
              ...
              <div class="card card-blog">
                <div class="card-image">
                  <a href="#pablo">
                    <img src="{{ asset('img/examples/color3.jpg') }}" alt="" />
                  </a>
                </div>
                <div class="card-content">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="card card-blog card-plain">
                    <div class="card-image">
                      <a href="#pablo">
                      <img src="{{ asset('img/examples/blog5.jpg') }}" alt="" />
                        <div class="card-title">
                          This Summer Will be Awesome
                        </div>
                      </a>
                ...
                <div class="col-md-4">
                  <div class="card card-blog card-plain">
                    <div class="card-image">
                      <a href="#pablo">
                        <img class="img" src="{{ asset('img/examples/blog1.jpg') }}" />
                      </a>
                    </div>
                ...
                <div class="col-md-4">
                  ...
                  <div class="card card-blog card-plain">
                    <div class="card-image">
                      <a href="#pablo">
                        <img class="img" src="{{ asset('img/examples/blog6.jpg') }}" />
                      </a>
                    </div>
